...
final class Max extends Rule
{
    ...
    public function validate(): bool
    {
        ...
        return $this->fieldValue <= $this->maxValue;
    }
    ...
    {
        return [$this->maxValue, $this->fieldLabel];
    }
}
